...
const Home = () => {
  return (
    <div name='home' className=' px-24 h-screen w-full bg-gradient-to-b bottom from-black via-black to-gray-800'>
        ...
        repeat={0}
        wrapper='span'
        className='text-4xl sm:text-6xl font-bold text-yellow-50'
        sequence={[
          "I am front end developer",
          3000,
          "Creating seamless and user-centric web experiences!",
          2000,
          "I am front end developer",
          3000,
  ...
  src={HeroImage}
  alt="my image"
  className='rounded-3xl mx-auto w-full md:w-1/2 my-2 md:my-1 min-w-40 duration-500 hover:scale-150 shadow-2xl shadow-gray-700'
/>
</div>
